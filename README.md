...
2.	Node Modules-contains node modules installed during node setup.
3.	Static- It contains the public/static files used in the projects like scripts, CSS files, images, etc.
4.	Middleware-This directory contains the middlewares that are used in the server for proper navigation and for implementing certain functionalities.
5.	Uploads- It contains the files that will be uploaded by the users.
